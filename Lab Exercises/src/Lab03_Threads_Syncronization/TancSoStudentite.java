...
public class TancSoStudentite {
    ...
    Semaphore mMax;
    Semaphore zMax;
    Semaphore zenskiReady;
    Semaphore salaZaTanc;
    

    public void init() {
        //TODO: da se implementira
        mMax = new Semaphore(10); // kontrolira maski vo soblekuvalna
        zMax = new Semaphore(10); // kontrolira zenski vo soblekuvalna
        zenskiReady = new Semaphore(0); // kontrolira dali nekoe masko ima soodvetno spremno zensko
        salaZaTanc = new Semaphore(3); // kontrolira kolku se na binata (3 max)
    }
