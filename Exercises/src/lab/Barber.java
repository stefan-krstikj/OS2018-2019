...
class TemplateNumRunsAndNumInstances {
    ...
    static class Barber extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            ...
            secenjeReady.acquire();
            state.cutHair();
            izlezi.release();
            // proveruva dali ima klienti koi cekaat, ako nema, zaspiva
            System.out.println("Available permits: " + striziReady.availablePermits());
            if(striziReady.availablePermits() < 5){
