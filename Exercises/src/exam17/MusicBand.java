...
//    static int gitaristiN;
//    static Lock lock;
//
//    static Semaphore gitaristi;
//    static Semaphore peaci;
//
//    static Semaphore gitaristiReady;
//    static Semaphore peaciReady;
//    static Semaphore allReady;
//
//    static Semaphore playingDone;
//
//    public static void init() {
//        //TODO: da se implementira
//        gitaristi = new Semaphore(3);
//        peaci = new Semaphore(2);
//        gitaristiN = 0;
//        lock = new ReentrantLock();
//        gitaristiReady = new Semaphore(0);
//        peaciReady = new Semaphore(0);
//        allReady = new Semaphore(0);
...
//            if(gitaristiN == 3){
//                lock.unlock();
//                gitaristiReady.acquire(2);
//                peaciReady.acquire(2);
//                allReady.release(5);
//            }
//            else{
//                lock.unlock();
//                gitaristiReady.release();
//            }
//            allReady.acquire();
//            state.play();
//            playingDone.release();
