...
public class ExamSolution {
    ...
    static Semaphore profesori;
    static Semaphore izleziStudentiReady;
    static Semaphore izleziProfesorReady;

    static Semaphore studentiHere;
    static Semaphore getTest;
    static Semaphore testDone;


    public static void init() {
        studenti = new Semaphore(0);
        profesori = new Semaphore(1);

        izleziStudentiReady = new Semaphore(0);
        izleziProfesorReady = new Semaphore(0);

        studentiHere = new Semaphore(0);
        getTest = new Semaphore(0);
    ...
    public static class Teacher extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            ...
            studentiHere.acquire(50);
            state.distributeTests();

            getTest.release(50);
            testDone.acquire(50);
            state.examEnd();
            izleziStudentiReady.release(50);
            izleziProfesorReady.acquire(50);
            state.teacherLeave();
            profesori.release();
        }
    }
    ...
    public static class Student extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            ...
            studentiHere.release();
            getTest.acquire();
            testDone.release();

            izleziStudentiReady.acquire();
            state.studentLeave();
            izleziProfesorReady.release();
...
class ExamState extends AbstractState {
